...
def dll_work(_item):
    ...
    try:
        ctypes.CDLL(os.path.join(r'C:\Users\user\Desktop\Лаба\Максим\2.2\dll', _item))
    except OSError:
...
def dll_connection(_item):
    ...
    return ctypes.CDLL(os.path.join(r'C:\Users\user\Desktop\Лаба\Максим\2.2\dll', _item))
